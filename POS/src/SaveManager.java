...
public class SaveManager {
    ...
    public static void saveCustomers(CustomerList customerList) {
        try (ObjectOutputStream out = new ObjectOutputStream(new FileOutputStream(CUSTOMERS_FILE))) {
    ...
    @SuppressWarnings("Unchecked")
    public static CustomerList loadCustomers() {
        ...
        try (ObjectInputStream in = new ObjectInputStream(new FileInputStream(CUSTOMERS_FILE))) {
            return (CustomerList) in.readObject();
        } catch (IOException | ClassNotFoundException e) {
            e.printStackTrace();
 ...
 * FileOutputStream(NUMBER_OF_USERS_FILE))) {
 ...
 * // Dummy 1
 * User user1 = new User("GeraltOfRivia", "whitewolf", dummyUserNu++,
 * "Marshland");
 ...
 * 
 * // Dummy 2
 * User user2 = new User("YenneferOfVengerberg", "sorceress", dummyUserNu++,
 * "Arcane");
 ...
 * 
 * // Dummy 7
 * User user7 = new User("Ciri", "princessOfCintra", dummyUserNu++,
 * "Hillcrest");
 ...
 * 
 * // Dummy 14
 * User user14 = new User("SansaStark", "queenOfNorth", dummyUserNu++,
 * "Arcane");
 ...
 * 
 * // Dummy 19
 * User user19 = new User("RobertJohnson", "robert", dummyUserNu++,
 * "Hillcrest");
